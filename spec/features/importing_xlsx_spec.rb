...
feature 'index displays a list of contacts after uploading .xlsx file' do
  scenario 'the index displays correct header & contact information' do
    ...
    attach_file('file', 'data.xlsx')
    click_button('Import')

    # we need to wait because importing .xlsx is slow, sleep is not the optimal method but I am unsure how to use wait_until with Capybara
    sleep(30)
